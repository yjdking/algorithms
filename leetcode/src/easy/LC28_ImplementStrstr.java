...
/**
 * @ClassName: LC28_ImplementStrstr
 * @Description: 实现strStr()
 * @Author: 余佳东
 * @Date: 2018-12-07 10:59
 * @Version: V1.0
 **/
public class LC28_ImplementStrstr {
    /**
     * @Description: 窗口法, 7 ms, 在Implement strStr()的Java提交中击败了63.84% 的用户
    ...
    public int strStr(String haystack, String needle) {
        ...
        for (int i = 0, len = haystack.length(); i <= len - needLength; i++) {
            // System.out.println(haystack.substring(i, i + needLength));
